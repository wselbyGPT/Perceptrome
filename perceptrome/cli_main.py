...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_virus_training_args(sp):
        sp.add_argument("--catalog", default=None, help="Virus catalog path")
        sp.add_argument("--catalog-manifest", default=None, help="Virus catalog manifest path (catalog.manifest.json)")
        sp.add_argument("--fetch-manifest", default=None, help="Virus fetch manifest path (fetch.manifest.json)")
        sp.add_argument("--complete-only", action="store_true", help="Record complete-genome-only policy in run provenance")
        sp.add_argument("--refseq-only", action="store_true", help="Record RefSeq-only policy in run provenance")
        sp.add_argument("--sequence-source", choices=["genome", "cds", "protein"], default="genome", help="Virus sequence source selection")
        sp.add_argument("--segmented-policy", default="none", help="Segmentation handling policy (recorded in provenance)")
        sp.add_argument("--dedupe", default="none", help="Virus dedupe mode (recorded in provenance)")
        sp.add_argument("--metadata-path", default=None, help="Path to optional virus metadata sidecar")
    ...
    add_tensorboard_args(s)
    add_model_args(s)
    add_virus_training_args(s)
    s.set_defaults(func=_lazy_cmd("cmd_virus_stream"))

    s = sub.add_parser("virus-encode-one")
    s.add_argument("accession")
    s.add_argument("--window-size", type=int, default=None)
    s.add_argument("--stride", type=int, default=None)
    add_tok_args(s)
    add_virus_training_args(s)
    s.set_defaults(func=_lazy_cmd("cmd_virus_encode_one"))

    s = sub.add_parser("virus-train-one")
    s.add_argument("accession")
    s.add_argument("--steps", type=int, default=None)
    s.add_argument("--batch-size", type=int, default=None)
    s.add_argument("--window-size", type=int, default=None)
    ...
    add_model_args(s)
    add_virus_training_args(s)
    s.set_defaults(func=_lazy_cmd("cmd_virus_train_one"))
