...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--generator-mode", choices=["vae", "diffusion"], default=None, help="Generation sampler: baseline VAE latent sampling or diffusion-like latent refinement")
    s.add_argument("--diffusion-steps", type=int, default=None)
    s.add_argument("--diffusion-eta", type=float, default=None)
    s.add_argument("--diffusion-noise", type=float, default=None)
