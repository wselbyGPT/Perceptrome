...
DEFAULT_COMMANDS: tuple[LauncherCommand, ...] = (
    ...
    LauncherCommand("panel.artifacts", "Jump: Outputs", "panel", panel_id="artifacts", keywords=("checkpoint", "manifest", "output")),
    LauncherCommand("panel.models", "Jump: Models", "panel", panel_id="models", keywords=("checkpoint", "weights", "model")),
    ...
    LauncherCommand("panel.diagnostics", "Jump: Diagnostics", "panel", panel_id="diagnostics", keywords=("env", "health", "gpu", "memory")),
    LauncherCommand("panel.settings", "Jump: Settings", "panel", panel_id="settings", keywords=("preferences", "cache", "toggles")),
