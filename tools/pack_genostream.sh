...
#
# Usage:
#   ./tools/pack_genostream.sh
#   ./tools/pack_genostream.sh --outdir /path/to/out --name genostream
#   ./tools/pack_genostream.sh --include-runs
#   ./tools/pack_genostream.sh --include-cache
#   ./tools/pack_genostream.sh --include-venv
